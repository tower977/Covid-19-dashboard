...
#setwd("/Users/Sully/Desktop/Github_Repo/R_Codes/Corona/Final Codes/Flexdashboard")
...
leafletsubtitle <- tags$div(subtitle, HTML("David O'Sullivan"))  
...
Mapwithvalues <- leaflet() %>%
    addTiles() %>%
    setView(lat=53.1424, lng=1.6921, zoom = 6) %>%
...
News from Ireland {data-orientation=rows}
=========================================

Row {.tabset .tabset-fade}
-------------------------------------

### RTE live Feed {data-height=3000}

```{r}
h2("Under Development")
```

### WHO/HSE Feed {data-height=3000}

```{r}
h2("Under Development")
```

### Virus updates {data-height=3000}
...
div("This project was inspired by the World Health Organisation's dashboard visualisation on the spread and global impact of covid-19. The dashboard has not been completed fully as the news from Ireland section is to be equipped with web scrapers to display headlines from various news sources aand the url link to connect users to said article.")

div(
  "---------------"
  )

a(href="https://covid19.who.int/?gclid=Cj0KCQjwu8r4BRCzARIsAA21i_CDqcxuVPu5R7E4kDRyQ_rsokubOcE5OIObkNR2chms5jKzWRxFT-caAjcGEALw_wcB", "WHO Dashboard")

div(
  "---------------"
  )

a(href="https://shiny.rstudio.com/gallery/covid19-tracker.html", "Shiny Example")
